...
public class CompetitionLogics implements ActionListener {
        private CompetitionManagement cm;
        
        public CompetitionLogics(CompetitionManagement cm){
                this.cm = cm;
        }
                ...
                il.addMouseListener(new MouseListener(){
                        ...
                        public void mouseReleased(MouseEvent e) {
                                ...
                                if(source.isTriggered()){
                                        source.cR.setBackground(source.cR.getColor(), true);
